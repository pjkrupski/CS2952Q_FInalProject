python train.py --batch-size=16 --epochs 120 --lr=2e-4 --model-name cnn --output-file models/cnn_none.pt
...
python train.py --batch-size=16 --epochs 120 --lr=1e-5 --model-name --output-file models/vit_none.pt
